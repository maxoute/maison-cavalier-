    ...
    <form action={action} className="space-y-5 max-w-2xl">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <Select
            id="owner_status"
            name="owner_status"
            defaultValue={resident?.owner_status ?? "proprietaire"}
          >
      ...
      <div>
        ...
        <Textarea
          ...
          placeholder="Ex. pressing chaque lundi matin, journaux…"
        />
      </div>
      <div>
        ...
        <Textarea
          ...
          name="special_access"
          rows={2}
          defaultValue={resident?.special_access ?? ""}
          placeholder="Ex. badge cave n°12, ascenseur privatif…"
        />
      </div>
      <div>
        ...
        <Textarea
          ...
          name="internal_notes"
          rows={3}
          defaultValue={resident?.internal_notes ?? ""}
          placeholder="Visibles uniquement par la conciergerie."
        />
      </div>

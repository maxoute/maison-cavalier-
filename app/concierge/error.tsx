...
export default function ConciergeError({ unstable_retry }: { unstable_retry: () => void }) {
  const [pending, startTransition] = useTransition();
  return <div className="space-y-4 text-base" role="alert">
    <h1 className="text-3xl">Chargement interrompu</h1>
    <p>Les données de la conciergerie ne sont pas disponibles pour le moment. Réessayez dans un instant.</p>
